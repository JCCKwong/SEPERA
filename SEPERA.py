    ...
    with st.form(key="my_form"):
        ...
        if submitted:
            ...
            if mid_findings_r == 1:
                ...
                image.paste(image_mr_G1, (1660, 965), mask=image_mr_G1)
            if mid_findings_r == 2:
                image_mr_G2 = PIL.Image.open('Images/Mid 2.png').convert('RGBA')
                image.paste(image_mr_G2, (1660, 965), mask=image_mr_G2)
            if mid_findings_r == 3:
                image_mr_G3 = PIL.Image.open('Images/Mid 3.png').convert('RGBA')
                image.paste(image_mr_G3, (1660, 965), mask=image_mr_G3)
            if mid_findings_r == 4:
                image_mr_G4 = PIL.Image.open('Images/Mid 4.png').convert('RGBA')
                image.paste(image_mr_G4, (1660, 965), mask=image_mr_G4)
            if mid_findings_r == 5:
                image_mr_G5 = PIL.Image.open('Images/Mid 5.png').convert('RGBA')
                image.paste(image_mr_G5, (1660, 965), mask=image_mr_G5)
