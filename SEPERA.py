    ...
    with st.sidebar:
        with st.form(key="my_form"):
            ...
            if submitted:
                ...
                draw.text((735, 1170), mid_L, fill="black", font=font, align="center")
                draw.text((735, 525), apex_L, fill="black", font=font, align="center")
                draw.text((1690, 1820), base_R, fill="black", font=font, align="center")
                draw.text((1690, 1170), mid_R, fill="black", font=font, align="center")
                draw.text((1690, 525), apex_R, fill="black", font=font, align="center")
