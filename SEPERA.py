...
def about(session_state):
    ...
    *Jethro CC. Kwong$^{1,2}$, Adree Khondker$^{3}$, Eric Meng$^{4}$, Nicholas Taylor$^{3}$, Nathan Perlis$^{1}$, 
    ...
    IMM.image("Images/IMM.png", width=400, caption="L'Institut Mutualiste Montsouris, Paris, France")
    JB.image("Images/JB.png", width=400, caption="Jules Bordet Institute, Brussels, Belgium")
